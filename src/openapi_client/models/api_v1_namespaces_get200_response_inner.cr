...
module OpenAPIClient
  class ApiV1NamespacesGet200ResponseInner
    ...
    @[JSON::Field(key: "actor_id", type: String, nillable: false, emit_null: false)]
    ...
    def initialize(@id : String, @name : String, @team_id : String, @state : String, @region : String, @actor_id : String, @created_at : String, @updated_at : String, @description : String?)
    end
    ...
    def hash
      [id, name, team_id, description, state, region, actor_id, created_at, updated_at].hash
    end
