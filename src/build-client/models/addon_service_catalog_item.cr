...
module Build
  class AddonServiceCatalogItem
    ...
    @[JSON::Field(key: "human_name", type: String, nillable: false, emit_null: false)]
    ...
    # Optional properties
    @[JSON::Field(key: "supports_log_drains", type: Bool?, nillable: true, emit_null: false)]
    property supports_log_drains : Bool?

    @[JSON::Field(key: "supports_sharing", type: Bool?, nillable: true, emit_null: false)]
    property supports_sharing : Bool?
