...
module Build
  class Namespace
    ...
    def initialize(@id : String?, @name : String?, @team : AppTeam?, @description : String?, @state : String?, @region : String?, @actor : NamespaceActor?, @created_at : String?, @updated_at : String?)
    end
