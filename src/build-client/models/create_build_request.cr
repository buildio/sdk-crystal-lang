...
module Build
  class CreateBuildRequest
    ...
    @[JSON::Field(key: "commitish", type: String?, nillable: true, emit_null: false)]
    property commitish : String?
    ...
    def initialize(@branch : String?, @commitish : String?, @description : String?)
    end
