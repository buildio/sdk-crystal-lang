...
module Build
  class Dyno
    ...
    @[JSON::Field(key: "processes", type: Array(DynoProcessesInner), nillable: false, emit_null: false)]
    property processes : Array(DynoProcessesInner)

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@_type : String, @quantity : Int32, @size : String, @display : String, @processes : Array(DynoProcessesInner))
    end
