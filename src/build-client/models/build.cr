...
module Build
  class Build
    ...
    @[JSON::Field(key: "buildpacks", type: Array(Object)?, nillable: true, emit_null: false)]
    property buildpacks : Array(Object)?

    @[JSON::Field(key: "output_stream_url", type: String?, nillable: true, emit_null: false)]
    property output_stream_url : String?

    @[JSON::Field(key: "slug", type: Object?, nillable: true, emit_null: false)]
    ...
    def initialize(@id : String, @app : GetPipelineDiff200ResponseSource, @stack : String, @state : String, @created_at : Time, @updated_at : Time, @user : BuildUser?, @source_blob : BuildSourceBlob?, @buildpacks : Array(Object)?, @output_stream_url : String?, @slug : Object?)
    end
